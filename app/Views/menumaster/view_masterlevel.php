...
<?= $this->section('content') ?>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="mb-0">Master level</h3>
              <p class="text-sm mb-0">
                Berisi data level yang dipilih ketika mengisi data user
              </p>
              <button type="button" class="btn btn-primary btn-sm mt-3" 
                      data-toggle="modal" data-target="#modaltambahmasterlevel" 
                      onClick="generatekodemasterlevel()">
               <i class="fa fa-plus-circle"></i> Tambah Data
              </button>
            </div>
            <div class="table-responsive py-4">
              <table class="table table-flush" id="datatable-masterlevel">
    ...
    <?= $this->include('menumaster/add_masterlevel'); ?>
    <?= $this->include('menumaster/edit_masterlevel'); ?>
<?= $this->endSection(); ?>