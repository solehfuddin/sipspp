 <!-- Modal ubah Info -->
 <div class="modal fade" id="modalubahpembayaran" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <!-- Handle Form -->
        <?= form_open_multipart('tunggakancontroller/simpandata', ['class' => 'formModalubahpembayaran']); ?>
        <?= csrf_field(); ?>
        ...
        <div class="modal-body ui-front">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" placeholder="Desti Handayani" 
                        name="pembayaran_search" id="pembayaran_search" readonly/>
                  <!-- Error Validation -->
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" placeholder="2021586711" 
                        name="pembayaran_nis" id="pembayaran_nis" readonly/>
                  <!-- Error Validation -->
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="pembayaran_month" name="pembayaran_month" readonly>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="pembayaran_year" name="pembayaran_year" readonly>
        ...
        <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-primary btnmodalubahpembayaran">Simpan</button>
        </div>
